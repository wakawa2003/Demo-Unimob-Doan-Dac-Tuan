...
namespace CodeStage.AntiCheat.EditorCode.Windows
{
	internal class ActPrefsEditor : EditorWindow
	{
		...
		[UnityEditor.MenuItem(ActEditorGlobalStuff.WindowsMenuPath + "Prefs Editor as Tab...", false, 500)]
		...
		[UnityEditor.MenuItem(ActEditorGlobalStuff.WindowsMenuPath + "Prefs Editor as Utility...", false, 501)]
			...
			switch (record.prefType)
			{
				...
				case PrefsRecord.PrefsType.Int:
					menu.AddItem(new GUIContent("Paste int value from clipboard"), false, () =>
					{
						...
						{
							Debug.LogWarning(ActEditorGlobalStuff.LogPrefix + "Can't paste this value to Int pref:\n" + valueToPaste);
						}
					});
					break;
				case PrefsRecord.PrefsType.Float:
					menu.AddItem(new GUIContent("Paste float value from clipboard"), false, () =>
					{
						...
						{
							Debug.LogWarning(ActEditorGlobalStuff.LogPrefix + "Can't paste this value to Float pref:\n" + valueToPaste);
						}
					});
					break;
				default:
		...
		internal class PrefsRecord
		{
			...
			internal bool Save(bool newRecord = false)
			{
				...
				{
					case PrefsType.Unknown:
						Debug.LogError(ActEditorGlobalStuff.LogPrefix + "Can't save Pref of unknown type!");
						break;
					case PrefsType.String:
			...
			internal void Encrypt()
			{
				...
				switch (prefType)
				{
					case PrefsType.Unknown:
						success = false;
						Debug.LogError(ActEditorGlobalStuff.LogPrefix + "Can't encrypt pref of unknown type!");
						break;
					case PrefsType.String:
						obscuredType = ObscuredPrefs.DataType.String;
						break;
